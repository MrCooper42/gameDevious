...
export class View_MessageInputComponent0 extends import1.AppView<import0.MessageInputComponent> {
  ...
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    ...
    this._el_9 = import3.createRenderElement(this.renderer,this._el_4,'input',new import3.InlineArray16(10,'class','form-control','id','content','name','content','required','','type','text'),(null as any));
    ...
    this._el_12 = import3.createRenderElement(this.renderer,this._el_2,'button',new import3.InlineArray4(4,'class','btn btn-danger','type','button'),(null as any));
    this._text_13 = this.renderer.createText(this._el_12,'Clear',(null as any));
    this._text_14 = this.renderer.createText(this._el_2,'\n        ',(null as any));
    this._el_15 = import3.createRenderElement(this.renderer,this._el_2,'button',new import3.InlineArray4(4,'class','btn btn-primary','type','submit'),(null as any));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import22.NgForm) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 17)))) { return this._NgForm_2_3.context; }
    if (((token === import23.ControlContainer) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 17)))) { return this._ControlContainer_2_4; }
    if (((token === import21.NgControlStatusGroup) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 17)))) { return this._NgControlStatusGroup_2_5.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_9_2_1:any = ((this.context.message == null)? (null as any): this.context.message.content);
  ...
  handleEvent_12(eventName:string,$event:any):boolean {
    ...
    var result:boolean = true;
    if ((eventName == 'click')) {
      const pd_sub_0:any = ((<any>this.context.onClear(this._NgForm_2_3.context)) !== false);
      result = (pd_sub_0 && result);
    }
    return result;
  }
