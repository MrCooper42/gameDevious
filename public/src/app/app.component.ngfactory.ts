...
export class View_AppComponent0 extends import1.AppView<import0.AppComponent> {
  ...
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    ...
    this._HeaderComponent_0_3 = new import10.Wrapper_HeaderComponent(this.parentView.injectorGet(import15.AuthService,this.parentIndex),this.parentView.injectorGet(import16.Router,this.parentIndex));
    ...
    this._RouterOutlet_6_5 = new import12.Wrapper_RouterOutlet(this.parentView.injectorGet(import17.RouterOutletMap,this.parentIndex),this._vc_6.vcRef,this.parentView.injectorGet(import18.ComponentFactoryResolver,this.parentIndex),(null as any));
    ...
    this._ErrorComponent_9_3 = new import14.Wrapper_ErrorComponent(this.parentView.injectorGet(import19.ErrorService,this.parentIndex));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import20.RouterOutlet) && (6 === requestNodeIndex))) { return this._RouterOutlet_6_5.context; }
