...
export var View_NgbCarousel0 = (function (_super) {
    ...
    View_NgbCarousel0.prototype.createInternal = function (rootSelector) {
        ...
        this._el_11 = import3.createRenderElement(this.renderer, parentRenderNode, 'a', new import3.InlineArray4(4, 'class', 'left carousel-control-prev', 'role', 'button'), null);
        this._text_12 = this.renderer.createText(this._el_11, '\n      ', null);
        this._el_13 = import3.createRenderElement(this.renderer, this._el_11, 'span', new import3.InlineArray4(4, 'aria-hidden', 'true', 'class', 'carousel-control-prev-icon'), null);
        ...
        this._el_19 = import3.createRenderElement(this.renderer, parentRenderNode, 'a', new import3.InlineArray4(4, 'class', 'right carousel-control-next', 'role', 'button'), null);
        this._text_20 = this.renderer.createText(this._el_19, '\n      ', null);
        this._el_21 = import3.createRenderElement(this.renderer, this._el_19, 'span', new import3.InlineArray4(4, 'aria-hidden', 'true', 'class', 'carousel-control-next-icon'), null);
