...
import * as import21 from '@ng-bootstrap/ng-bootstrap/datepicker/datepicker-day-view';
import * as import22 from './datepicker-day-view.ngfactory';
import * as import23 from '@ng-bootstrap/ng-bootstrap/datepicker/datepicker-navigation';
import * as import24 from './datepicker-navigation.ngfactory';
import * as import25 from '@ng-bootstrap/ng-bootstrap/datepicker/datepicker-month-view';
import * as import26 from './datepicker-month-view.ngfactory';
...
export var View_NgbDatepicker0 = (function (_super) {
    ...
    View_NgbDatepicker0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        if (import3.checkBinding(throwOnChange, this._expr_21, currVal_21)) {
            this.renderer.setElementStyle(this._el_3, 'height', ((this.viewUtils.sanitizer.sanitize(import20.SecurityContext.STYLE, currVal_21) == null) ? null : (this.viewUtils.sanitizer.sanitize(import20.SecurityContext.STYLE, currVal_21).toString() + 'rem')));
            this._expr_21 = currVal_21;
        }
        var currVal_22 = (0 - this.context.getHeaderMargin());
        if (import3.checkBinding(throwOnChange, this._expr_22, currVal_22)) {
            this.renderer.setElementStyle(this._el_3, 'marginBottom', ((this.viewUtils.sanitizer.sanitize(import20.SecurityContext.STYLE, currVal_22) == null) ? null : (this.viewUtils.sanitizer.sanitize(import20.SecurityContext.STYLE, currVal_22).toString() + 'rem')));
...
var View_NgbDatepicker1 = (function (_super) {
    ...
    View_NgbDatepicker1.prototype.createInternal = function (rootSelector) {
        ...
        this.compView_1 = new import22.View_NgbDatepickerDayView0(this.viewUtils, this, 1, this._el_1);
        this._NgbDatepickerDayView_1_3 = new import22.Wrapper_NgbDatepickerDayView();
    ...
    View_NgbDatepicker1.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import21.NgbDatepickerDayView) && (1 === requestNodeIndex))) {
...
var View_NgbDatepicker2 = (function (_super) {
    ...
    View_NgbDatepicker2.prototype.createInternal = function (rootSelector) {
        ...
        this.compView_0 = new import24.View_NgbDatepickerNavigation0(this.viewUtils, this, 0, this._el_0);
        this._NgbDatepickerNavigation_0_3 = new import24.Wrapper_NgbDatepickerNavigation(this.parentView.parentView.injectorGet(import10.NgbDatepickerI18n, this.parentView.parentIndex), this.parentView.parentView.injectorGet(import9.NgbCalendar, this.parentView.parentIndex));
    ...
    View_NgbDatepicker2.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import23.NgbDatepickerNavigation) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) {
...
var View_NgbDatepicker3 = (function (_super) {
    ...
    View_NgbDatepicker3.prototype.createInternal = function (rootSelector) {
        ...
        this.compView_5 = new import26.View_NgbDatepickerMonthView0(this.viewUtils, this, 5, this._el_5);
        this._NgbDatepickerMonthView_5_3 = new import26.Wrapper_NgbDatepickerMonthView(this.parentView.parentView.injectorGet(import10.NgbDatepickerI18n, this.parentView.parentIndex));
    ...
    View_NgbDatepicker3.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import25.NgbDatepickerMonthView) && ((5 <= requestNodeIndex) && (requestNodeIndex <= 6)))) {
