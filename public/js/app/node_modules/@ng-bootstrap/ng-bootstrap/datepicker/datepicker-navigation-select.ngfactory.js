...
export class Wrapper_NgbDatepickerNavigationSelect {
    constructor(p0, p1) {
        this._changed = false;
        this._changes = {};
...
class View_NgbDatepickerNavigationSelect_Host0 extends import2.AppView {
    constructor(viewUtils, parentView, parentIndex, parentElement) {
        super(View_NgbDatepickerNavigationSelect_Host0, renderType_NgbDatepickerNavigationSelect_Host, import6.ViewType.HOST, viewUtils, parentView, parentIndex, parentElement, import1.ChangeDetectorStatus.CheckAlways);
    }
...
export const NgbDatepickerNavigationSelectNgFactory = new import7.ComponentFactory('ngb-datepicker-navigation-select', View_NgbDatepickerNavigationSelect_Host0, import0.NgbDatepickerNavigationSelect);
const styles_NgbDatepickerNavigationSelect = ['select[_ngcontent-%COMP%] {\n      \n      padding: 0.25rem 0.5rem;\n      font-size: 0.875rem;      \n      line-height: 1.25;\n      \n      height: inherit;\n      width: 50%;\n    }'];
...
export class View_NgbDatepickerNavigationSelect0 extends import2.AppView {
    constructor(viewUtils, parentView, parentIndex, parentElement) {
        super(View_NgbDatepickerNavigationSelect0, renderType_NgbDatepickerNavigationSelect, import6.ViewType.COMPONENT, viewUtils, parentView, parentIndex, parentElement, import1.ChangeDetectorStatus.CheckAlways);
    ...
    detectChangesInternal(throwOnChange) {
        const currVal_3_0_0 = this.context.months;
        ...
        const currVal_7_0_0 = this.context.years;
        ...
        const currVal_16 = this.context.disabled;
        ...
        const currVal_17 = this.context.date.month;
    ...
    handleEvent_1(eventName, $event) {
        ...
        var result = true;
        if ((eventName == 'change')) {
            const pd_sub_0 = (this.context.changeMonth($event.target.value) !== false);
    ...
    handleEvent_5(eventName, $event) {
        ...
        var result = true;
        if ((eventName == 'change')) {
            const pd_sub_0 = (this.context.changeYear($event.target.value) !== false);
            result = (pd_sub_0 && result);
        }
        return result;
    }
}
class View_NgbDatepickerNavigationSelect1 extends import2.AppView {
    constructor(viewUtils, parentView, parentIndex, parentElement, declaredViewContainer) {
        super(View_NgbDatepickerNavigationSelect1, renderType_NgbDatepickerNavigationSelect, import6.ViewType.EMBEDDED, viewUtils, parentView, parentIndex, parentElement, import1.ChangeDetectorStatus.CheckAlways, declaredViewContainer);
    ...
    detectChangesInternal(throwOnChange) {
        ...
        const currVal_0_1_0 = this.context.$implicit;
        ...
        const currVal_4 = import3.inlineInterpolate(1, '', this.parentView.context.i18n.getMonthName(this.context.$implicit), '');
...
class View_NgbDatepickerNavigationSelect2 extends import2.AppView {
    constructor(viewUtils, parentView, parentIndex, parentElement, declaredViewContainer) {
        super(View_NgbDatepickerNavigationSelect2, renderType_NgbDatepickerNavigationSelect, import6.ViewType.EMBEDDED, viewUtils, parentView, parentIndex, parentElement, import1.ChangeDetectorStatus.CheckAlways, declaredViewContainer);
        this._expr_4 = import1.UNINITIALIZED;
    }
    createInternal(rootSelector) {
        this._el_0 = import3.createRenderElement(this.renderer, null, 'option', import3.EMPTY_INLINE_ARRAY, null);
    ...
    detectChangesInternal(throwOnChange) {
        ...
        this._NgSelectMultipleOption_0_4.check_value(currVal_0_1_0, throwOnChange, false);
        this._NgSelectMultipleOption_0_4.ngDoCheck(this, this._el_0, throwOnChange);
        const currVal_4 = import3.inlineInterpolate(1, '', this.context.$implicit, '');
        if (import3.checkBinding(throwOnChange, this._expr_4, currVal_4)) {
            this.renderer.setText(this._text_1, currVal_4);
            this._expr_4 = currVal_4;
        }
