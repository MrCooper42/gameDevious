...
var View_NgbDatepickerMonthView1 = (function (_super) {
    ...
    View_NgbDatepickerMonthView1.prototype.createInternal = function (rootSelector) {
        ...
        this._NgFor_4_6 = new import11.Wrapper_NgFor(this._vc_4.vcRef, this._TemplateRef_4_5, this.parentView.injectorGet(import13.IterableDiffers, this.parentIndex), this.parentView.ref);
