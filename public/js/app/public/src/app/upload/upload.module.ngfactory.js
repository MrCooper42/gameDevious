...
var UploadModuleInjector = (function (_super) {
    ...
    Object.defineProperty(UploadModuleInjector.prototype, "_NgLocalization_22", {
        get: function () {
            if ((this.__NgLocalization_22 == null)) {
                (this.__NgLocalization_22 = new import23.NgLocaleLocalization(this.parent.get(import34.LOCALE_ID)));
            }
    ...
    Object.defineProperty(UploadModuleInjector.prototype, "_RadioControlRegistry_23", {
        get: function () {
            if ((this.__RadioControlRegistry_23 == null)) {
                (this.__RadioControlRegistry_23 = new import24.RadioControlRegistry());
            }
    ...
    Object.defineProperty(UploadModuleInjector.prototype, "_NgbModal_24", {
        get: function () {
            if ((this.__NgbModal_24 == null)) {
                (this.__NgbModal_24 = new import25.NgbModal(this, this, this.parent.get(import35.NgbModalStack)));
            }
    ...
    UploadModuleInjector.prototype.getInternal = function (token, notFoundResult) {
        ...
        if ((token === import4.NgbAccordionModule)) {
            return this._NgbAccordionModule_2;
        }
        ...
        if ((token === import7.NgbCarouselModule)) {
            return this._NgbCarouselModule_5;
        }
        if ((token === import8.NgbCollapseModule)) {
            return this._NgbCollapseModule_6;
        }
