...
class View_MessageInputComponent_Host0 extends import1.AppView {
...
export const MessageInputComponentNgFactory = new import7.ComponentFactory('app-message-input', View_MessageInputComponent_Host0, import0.MessageInputComponent);
const styles_MessageInputComponent = [];
...
export class View_MessageInputComponent0 extends import1.AppView {
    constructor(viewUtils, parentView, parentIndex, parentElement) {
    ...
    detectChangesInternal(throwOnChange) {
        ...
        const currVal_9_2_0 = 'content';
        this._NgModel_9_7.check_name(currVal_9_2_0, throwOnChange, false);
        const currVal_9_2_1 = ((this.context.message == null) ? null : this.context.message.content);
    ...
    handleEvent_2(eventName, $event) {
        ...
        if ((eventName == 'ngSubmit')) {
            const pd_sub_0 = (this.context.onSubmit(this._NgForm_2_3.context) !== false);
    ...
    handleEvent_12(eventName, $event) {
        ...
        var result = true;
        if ((eventName == 'click')) {
            const pd_sub_0 = (this.context.onClear(this._NgForm_2_3.context) !== false);
            result = (pd_sub_0 && result);
        }
        return result;
    }
