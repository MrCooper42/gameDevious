...
export class View_HeaderComponent0 extends import1.AppView {
    constructor(viewUtils, parentView, parentIndex, parentElement) {
        ...
        this._map_57 = import3.pureProxy1((p0) => {
            return { in: p0 };
        });
    }
    createInternal(rootSelector) {
    ...
    detectChangesInternal(throwOnChange) {
        ...
        const currVal_22_0_1 = this._map_57(this.context.isIn);
        ...
        const currVal_42_0_0 = !this.context.belongsToUser();
        ...
        const currVal_44_0_0 = this.context.belongsToUser();
